"""
Django settings for mail_scraper project.
...
SECRET_KEY = 'django-insecure-8xpm_lass81hk&g&jf^k2r8c+@#_)vk$(d^hgkcom6y1f#h)+t'
...
ROOT_URLCONF = 'mail_scraper.urls'
...
WSGI_APPLICATION = 'mail_scraper.wsgi.application'
